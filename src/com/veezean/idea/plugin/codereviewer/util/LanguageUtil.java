...
public class LanguageUtil {
    ...
    private static void loadLanguageProperties() {
        loadLanguageProperties(FileConstants.LANGUAGE_EN_FILE_NAME, (k, v) -> englishProperties.put(k, v));
        loadLanguageProperties(FileConstants.LANGUAGE_ZH_FILE_NAME, (k, v) -> chineseProperties.put(k, v));
    }
